...
public class GEGKPSPublicSoap
{
    ...
    public GEGKPSPublicSoap(){}

    public GEGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GEGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GEGExtendedSoapSerializationEnvelope envelope= new GEGExtendedSoapSerializationEnvelope(GEGExtendedSoapSerializationEnvelope.VER11);
