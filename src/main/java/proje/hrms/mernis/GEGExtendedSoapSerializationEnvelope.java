...
public class GEGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GEGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new GEGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GEGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GEGDateTimeConverter dateTimeConverter = new GEGStandardDateTimeConverter();

    public GEGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GEGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GEGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GEGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GEGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GEGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
